...
Config.webhookUrl = "https://discord.com/api/webhooks/1325069193124511776/3_XXqrVxQRKpqNbyxtY5zMNIrG_d5vy-sGxyZghtHwdWawrPLoAYW3a5iCwz_VBaligu"
...
Config.StockMarketLocations = {  -- 
...

    {
        ...
        stocks = {             
             "bird", "pork", "beef", "venison", "biggame", "stringy", "game", "Mutton", "consumable_meat_succulent_fish_cooked", "eggs", "milk", "dogfood", "animal_rat",
